...
### How To Play
* 選單 & firebase membership machanism
一開始進入遊戲畫面，可以選擇訪客遊玩，也可以註冊帳號與登入。
* 關卡選擇 & Leaderboard
接著會進入此場景，若是新帳號，一開始只能玩第一關，破完才解鎖第二關。右上角的問號按下後會出現遊戲說明。在此場景也能觀看Leaderboard。按back可以退回到選單，按Log Out則會順便登出。
* 遊戲
...
場上會有金幣可以吃，增加遊戲分數。
* 音效
除了作業規定的BGM、jump、die，我還加了五個音效:踩敵人、吃金幣、獲得蘑菇效果、失去蘑菇效果、遊戲失敗、遊戲勝利。
